...
var footer = document.getElementsByClassName('footer-canvas'); // create an array of initial points
...
function combineRandomPoints() {
  var points = generateRandomPoints(16, 0, 8);
  var path = 'M0 0 L1024 0 L' + points[0] + ' L' + points[1] + ' L' + points[2] + ' L' + points[3] + ' L' + points[4] + ' L' + points[5] + ' L' + points[6] + ' L' + points[7] + ' L' + points[8] + 'L0 0 V0Z';
  return path;
}

;
var edgeStart = 'M0 0 L1024 0 L1024 0 L896 0 L768 0 L640 0 L512 0 L384 0 L256 0 L128 0 L0 0 V0Z'; // create an SVG
...
playground[0].prepend(createSVG(edgeStart, combineRandomPoints(), 'headerEdge')); // create the footer random edge
